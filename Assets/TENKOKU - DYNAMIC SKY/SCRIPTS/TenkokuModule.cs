...
bool totalEclipse = false;
	...
	void Start () {
        ...
        // Global Atmospheric Settings
        Shader.SetGlobalTexture("_ParticleDensityLUT", _particleDensityLUT);
        Shader.SetGlobalFloat("_AtmosphereHeight", AtmosphereHeight);
        Shader.SetGlobalFloat("_PlanetRadius", PlanetRadius);
        Shader.SetGlobalVector("_DensityScaleHeight", DensityScale);
        Shader.SetGlobalVector("_ScatteringR", RayleighSct * RayleighScatterCoef);
        Shader.SetGlobalVector("_ScatteringM", MieSct * MieScatterCoef);
        Shader.SetGlobalVector("_ExtinctionR", RayleighSct * RayleighExtinctionCoef);
        Shader.SetGlobalVector("_ExtinctionM", MieSct * MieExtinctionCoef);
        Shader.SetGlobalColor("_IncomingLight", IncomingLight);
        Shader.SetGlobalFloat("_MieG", MieG);
